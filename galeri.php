...
<div class="section">
        <div class="container">
            ...
            <a href="foto.php" class="add-button">Upload Foto</a>
            <!-- Konten Galeri Foto -->
            <div class="box">
                <?php
                    include 'koneksi.php';
                ...
                ?>
                <marquee class="no-data" direction="down" height="70"  scrolldelay="400">Foto Tidak Tersedia</marquee>
                <?php } ?>
            </div>
        </div>
    </div>
